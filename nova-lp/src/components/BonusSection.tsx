...
const bonuses = [
  {
    ...
    price: "R$ 47,00",
    desc: "Uma forma prática de ativar sua energia todos os dias e aumentar sua conexão com dinheiro e prosperidade.",
    items: ["Ingredientes acessíveis", "Passo a passo de preparo", "Ativação de prosperidade"],
    icon: "✨",
